...
client = pymongo.MongoClient('mongodb://dinesh:forcloud@ac-desczmm-shard-00-00.9kljutp.mongodb.net:27017,ac-desczmm-shard-00-01.9kljutp.mongodb.net:27017,ac-desczmm-shard-00-02.9kljutp.mongodb.net:27017/?ssl=true&replicaSet=atlas-m25q69-shard-0&authSource=admin&retryWrites=true&w=majority')
...
# Title
st.title('_Youtube Data Harvesting_')

# Data collection zone
with st.container():
    channel_id = st.sidebar.text_input('Enter Youtube channel ID')
    Get_data = st.sidebar.button('**Retrive Data**')
    ...
    if Get_data or st.session_state.Get_state:
        ...
        api_version = 'v3'
        api_key = 'AIzaSyCyTopZRoYpQbvm5DkEoPEyi1YiFrcjmwg'
        ...
        # channel data and videos data to a dictionary
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        from sqlalchemy import create_engine
        engine = create_engine("postgresql+psycopg2://postgres:dinesh@localhost/youtube", echo=False)
...
connect_for_question = psycopg2.connect(host='localhost', user='postgres', password='dinesh', database='youtube')
